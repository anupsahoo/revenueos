...
| 2026-09-06 | approx., single session | AI coding assistant | Phases 6 and 7: demo script, ten-slide deck, Q&A prep, submission page, v0.2.0 release | ~1h15 (approx.) | Keynote and PowerPoint both hung on first-run dialogs, so the PDF is rendered headlessly from an HTML mirror of the deck instead. Corrected a stale issue count (48 → 46 open) found while writing the submission page. Times approximate, not clock-tracked. |

**Total recorded so far:** about **6h30** of AI-assisted build time (Phase 0 ~0h45, Phase 2 ~2h00, Phases 1/3/4/5 ~2h30, Phases 6/7 ~1h15).

`[ANUP]` Add your own rows for the Friday evening and Saturday morning sessions. The honest answer to "how long did it take" is this table's total plus your hours, not rounded down.
